...
yy='yadm gui citool'
yya='yadm gui citool --amend'
yypull='yadm pull origin $(yadm_current_branch)'
yypush='yadm push origin $(yadm_current_branch)'
yysup='yadm branch --set-upstream-to=origin/$(yadm_current_branch)'
yh='yadm browse'
yhh='yadm help'
